...
\section{Folgen und Reihen}
       ...
       \subsection{Reihen}
              ...
              (\textbf{Cauchy Kriterium}) 
                     Die Reihe \textcolor{NavyBlue}{$\sum_{k=1}^\infty a_k$ }
              ...
              \colorbox{BurntOrange}{Korollar 2.7.7} (\textbf{Vergleichssatz}) Seien 
                     ...
                     \textcolor{NavyBlue}{
                     $0\leqslant a_k\leqslant b_k\quad\forall k\geqslant K$}\\
              \colorbox{cyan}{Definition 2.7.9} 
                     Die Reihe \textcolor{NavyBlue}{$\sum_{k=1}^\infty a_k$} ist 
              ...
              \colorbox{magenta}{Satz 2.7.10} 
                     ...
                     \textcolor{NavyBlue}{
                     $|\sum_{k=1}^\infty a_k|\leqslant\sum_{k=1}^\infty |a_k|$}\\
              \colorbox{magenta}{Satz 2.7.12} (\textbf{Leibniz} 1682) Sei 
                     ...
                     \textcolor{NavyBlue}{$S:=\sum_{k=1}^\infty (-1)^{k+1}a_k$} 
                     und es gilt: 
