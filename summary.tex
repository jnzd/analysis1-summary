...
\section{Folgen und Reihen}
       ...
       \subsection{Reihen}
              ...
              %        $(c_k)_{k\geqslant0}$} 
              %        eine Folge (in 
              %        \textcolor{NavyBlue}{$\R$} oder 
              %        \textcolor{NavyBlue}{$\C$}). Wenn 
              %        \begin{equation*}
       ...
       \subsection{Zentrale Sätze über die Ableitung}
              ...
              \colorbox{cyan}{Definition 4.2.13} 
                     \colorbox{SkyBlue}{(1)} 
                            ...
                            \textcolor{NavyBlue}{$\forall x$},
                            \textcolor{NavyBlue}{$y\in I$},
                     ...
                     \colorbox{SkyBlue}{(2)} 
                            ...
                            \textbf{streng konvex}, 
                            wenn \textcolor{NavyBlue}{$\forall x$},
                            \textcolor{NavyBlue}{$y\in I$},
...
\section{Wichtige Beispiele}
       ...
       % \colorbox{gray}{Allgemeine Potenzen}
       %        Wir können die Exponentialfunktion
